...
const ChatItem = ({
  ...
  const isAdmin = currentMember.role === DiscordMemberRole.ADMIN;
  const isModerator = currentMember.role === DiscordMemberRole.MODERATOR;
        ...
        <div className="flex flex-col w-full">
          ...
          {isPDF && (
            <div className="relative flex items-center p-2 mt-2 rounded-md bg-background/10">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="ml-2 text-sm text-indigo-500 dark:test-indigo-400 hover:underline"
              >
                PDF FILE
              </a>
            </div>
          ...
          {!fileUrl && isEditing && (
            <Form {...form}>
              ...
              <span className="text-[10px] mt-1 text--400">
